...
@client.command()
async def help(ctx):
	embed = discord.Embed(title = 'Available bot commands', description = '`<  >` - required arguments\n`[  ]` - not required arguments\n\nMake sure to join our [Telegram Group](https://t.me/oauth2service) incase Discord Server t3rm')
	...
	embed.set_footer(text = f'Developed by eth | https://github.com/notxVirus/discord-reputation-bot', icon_url = 'https://media.discordapp.net/attachments/1140645551180894209/1140695745486409768/git.png')
